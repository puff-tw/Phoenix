class StockReconciliationReport < ActiveType::Object

  def self.locationwise_stock_summary_table(options = {}, filter_params={})

    from_date = filter_params[:from_date] || GlobalSettings.start_date
    to_date = filter_params[:to_date] || Time.now.strftime('%d/%m/%Y')
